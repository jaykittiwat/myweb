          ...
          axios
            ...
            .then(res => {
             ...
             setUid(res.data[0].user)
              ...
              const result =await axios.get("https://aipcattle.herokuapp.com/notification/notiAll/"+UID )
              const result2 =await axios.get("https://aipcattle.herokuapp.com/treatment/notiAll/"+UID )
