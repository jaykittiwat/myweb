        ...
        .get("http://localhost:24559/user/logIn/" + user.email).then(res=>{
          ...
          axios.get("http://localhost:24559/settingcolor/color/"+this.state.UID).then(res=>{
            ...
            axios.get("http://localhost:24559/settingstrian/strian/"+this.state.UID).then(res=>{
              ...
              const bc=await axios.get("http://localhost:24559/settingbigcorral/bigcorral/"+this.state.UID)
              const cr=await axios.get("http://localhost:24559/settingcorral/corral/"+this.state.UID)
              const hn=await axios.get("http://localhost:24559/settingherd_num/herd_num/"+this.state.UID)
