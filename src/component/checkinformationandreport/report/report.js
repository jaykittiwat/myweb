      ...
      if(user){
        axios
          ...
          .then(res => {
           ...
           const datacattle = await axios.get("http://localhost:24559/cattle/showAll/" +this.state.UID)
           const datacalf = await axios.get("http://localhost:24559/calf/calfshowAll/" +this.state.UID)
